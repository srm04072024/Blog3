    ...
    <Container>
      <nav className=" flex items-center gap-2 bg-slate-100 border-gray-200 border-b-2 fixed z-[1000] top-0 left-0 w-full px-2 lg:px-6">
        <div className="flex-1 max-w-screen-xl flex flex-wrap items-center justify-between  mx-auto p-4">
          ...
          {user && (
            <div className="flex justify-between items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
              <span className="italic mr-3 hidden sm:flex">
              ...
              {isDropdownOpen && (
                <div
                  ref={dropdownRef}
                  className="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow absolute top-16 right-4"
                >
                ...
                (item) =>
                  item.active && (
                    <li key={item.slug}>
                      <a
                        href={item.slug}
                        className="block py-2 px-3 text-gray-900 rounded-md hover:bg-gray-300 md:hover:bg-transparent md:hover:text-blue-700 md:hover:bg-pink-200 border md:px-3 md:py-1"
                      >
                        {item.name}
                      </a>
                    </li>
