    ...
    <div className="flex items-center justify-center m-auto sm:w-full">
      ...
      >
        <div className="text-center">
          Welcome blogger
          <h2 className="text-center text-2xl md:text-2xl font-bold leading-tight">
            Sign in
          </h2>
        </div>
        ...
        <form onSubmit={handleSubmit(loginFn)} className="mt-8">
          <div className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full font-bold text-xl hover:bg-yellow-100 bg-green-200"
            >
              Submit
            </Button>
          </div>
        ...
        <div className="text-sm font-semibold text-center mt-2">
          ...
          <span
            ...
            className="italic underline hover:text-blue-700 cursor-pointer mx-1 text-sm text-gray-700"
          >
            Signup
          </span>
        </div>
